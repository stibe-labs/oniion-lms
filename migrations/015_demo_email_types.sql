-- Migration 015: Add demo email template types to email_log constraint
-- The demo system sends three email types not in the original CHECK constraint.

ALTER TABLE email_log DROP CONSTRAINT email_log_template_type_check;
