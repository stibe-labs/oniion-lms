-- Add 'session_extended' to room_events event_type CHECK constraint
...
ALTER TABLE room_events ADD CONSTRAINT room_events_event_type_check CHECK (
  event_type = ANY (ARRAY[
    ...
    'recording_started','recording_stopped','attention_update',
    'exam_started','exam_submitted','teacher_joined','teacher_left',
    ...
    'monitoring_alert','teacher_camera_toggle','student_attention_low',
    ...
    'egress_ended','ghost_mode_entry','ghost_mode_exit',
    'session_extended'
  ])
);
