    ...
    <div className="flex h-screen flex-col bg-zinc-950">
      ...
      <div className="flex h-11 sm:h-12 items-center justify-between border-b border-zinc-800/60 px-3 sm:px-4 shrink-0">
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
          <div className="flex h-6 w-6 sm:h-7 sm:w-7 items-center justify-center rounded-lg bg-primary/20 shrink-0">
            <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function ControlBtn({ children, onClick, tip, on = false, danger = false, accent = false, className = '' }: {
  ...
  else if (accent && on) bg = 'bg-primary text-white hover:bg-primary';
